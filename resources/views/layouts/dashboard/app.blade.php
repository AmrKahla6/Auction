            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            @if (auth()->user()->image)
                                <img src="{{ asset('uploads/user_images/' . auth()->user()->image)}}" width="20" height="20" class="img-circle" alt="User Image">
                            @else
                                <img src="{{ asset('uploads/user_images/default.png')}}" width="20" height="20" class="img-circle" alt="User Image">
                            @endif
